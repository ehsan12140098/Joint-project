import BlogsSideSection from '../BlogsSideSection/BlogsSideSection';
...
export default function BlogsSide() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      />
      <BlogsSideSection title="محبوب ترین مطالب" items={items.slice(0, 6)} />
    </div>
  );
}
