...
import bisantextimage from "../../Assets/images/bisantextimage.png";
...
{
  /* <div className="description-search-holder">
          <div className="bisan-description">
            <div className="bisan-title">بیسان سیر</div>
            <div className="bisan-subtitle">
              با بیسان سیر به بیش از 50 نقطه ی دنیا سفر کن
            </div>
          </div>
          <div className="main-search">
            <div className="search">
              <div className="Plus-text">جستجو</div>
              <SearchIcon />
            </div>
            <div className="number">
              ...
              <div className="Plus-text">نفرات</div>
            ...
            <div className="data">
              <div className="data-text">تاریخ</div>
              <div className="data-icon">
                <Calendar />
              </div>
            </div>
            <div className="destination">
              <div className="destination-text">مقصد</div>
              <div className="destination-icon">
                <AirplaneLanding />
              </div>
            </div>
            <div className="origin">
              <div className="origin-text">مبدا</div>
